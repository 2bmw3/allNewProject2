        ...
        var s, n, r, a, o, l = function(t) {
            ...
            c = function(s, n, r, a) {
                ...
                this.check = function(h) {
                    ...
                    if (0 === v && r)
                        for (u = ("com.greensock." + s).split("."), m = u.pop(), f = l(u.join("."))[m] = this.gsClass = r.apply(r, o), a && (i[m] = f, "function" == typeof define && define.amd ? define((t.GreenSockAMDPath ? t.GreenSockAMDPath + "default.htm" : "") + s.split(".").pop(), [], function() {
                                return f
