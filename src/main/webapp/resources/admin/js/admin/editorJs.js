...
var nicEditorConfig = bkClass.extend({
    ...
    iconsPath: '/resources/admin/nic/nicEditorIcons.gif',
...
$(window).load(function(){
	...
	var str = "<a href='#layer2' class='btn-example'><div style='float: left; margin-top: 2px;'><div class=' nicEdit-buttonContain' style='width: 20px; height: 20px; opacity: 0.6;'>"
		+ "<div class=' nicEdit-button-undefined' style='background-color: rgb(239, 239, 239);border: 1px solid rgb(239, 239, 239);'>"
		+ "<div class=' nicEdit-button' unselectable='on' style='width: 18px; height: 18px;	overflow: hidden; zoom: 1;"
		+ "cursor: pointer; background-image: url(&quot;/resources/admin/nic/upico.png&quot;);"
		+ "background-position: 0px 0px;'></div></div></div></div></a>";

$(".nicEdit-panel").append(str);
});
